...
function route(ctx) {
  ...
  switch (cmd) {
    ...
    case '取消下單': case '取消登記': return orders.cancel(userId, userName, args);
    ...
    case '回報繳費': return payments.reportPayment(userId, userName, args);
    ...
    case '幫助': case 'help': case '？': case '?': return info.help(isAdmin, isOwner);
    default: return null;
  }
}
